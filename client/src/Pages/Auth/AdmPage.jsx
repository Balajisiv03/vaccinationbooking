...
function showlist(){
  if(!showdetails){
    Axios.get("http://localhost:5001/data/getinsertdetails").then((response)=>{
...
const Submitadmdata = (e) => {
  ...
  Axios.post("http://localhost:5001/data/insertdetails",{cityname,vcentres,slot})
    .then(response => {
              ...
              <div>
                 <label htmlFor="name">
                  ...
                  <label htmlFor="dosdetails">
                    ...
                    <input type="number" id="dosdetails" name="dosdetails" placeholder="No of slots" style={{height: "30px"}}  
                    onChange={(e)=>{setSlot(e.target.value)}}/>
                  </label>
                  <label htmlFor="addcentres">
                      <h4> Add Vaccination centres</h4>
                      <input type="text" id="addcentres" name="addcentres" placeholder="Add centres" style={{height: "30px"}} 
