    ...
    <section className="auth-section">
       ...
       <form> 
              ...
              <div style={{display:"flex", alignItems: "center", justifyContent: "space-between"}}>
                  <button type="button" className="auth-btn" onClick={bookSlot}>Book a slot</button>
                  <button type="submit" className='handle-switch-btn' onClick={handlebtn}>Logout</button>
              </div>
              <div>
